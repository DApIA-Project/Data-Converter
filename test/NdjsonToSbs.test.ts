...
describe('NdndjsonToSbs', () => {
  context('Data ndjson no valid', () => {
    ...
    it('return empty content when error in ndjson syntax', async () => {
      ...
      const expectedResult: string =
        'SyntaxError: Unexpected string in JSON at position 218'
      assert.deepStrictEqual(sbsContent, expectedResult)
    })
  ...
  context('Data ndjson valid', () => {
    ...
    it('return sbs content when ndjson content is valid with aircraftID present second time', async () => {
      const ndjsonContent: string =
        '{"timestamp":"1659127350","icao24":"34648e","latitude":"43.84039306640625","longitude":"1.292171034702035","groundspeed":"291.0","track":"355.66173320857183","vertical_rate":"2752.0","callsign":"SWN5614","onground":"True","alert":"True","squawk":"NaN","altitude":"7450.0","geoaltitude":"7450.0","last_position":"","lastcontact":"","hour":""}\n' +
