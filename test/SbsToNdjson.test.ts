...
describe('SbsToNdjson', () => {
  context('Data sbs valid', () => {
    it('return empty content when sbs content is no valid missing attributes', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1'
    ...
    it('return empty content when sbs content is no valid icao is empty', async () => {
      const sbsContent: string =
        'MSG,3,1,1,,1,2023/01/01,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent)
    ...
    it('return empty content when sbs content is no valid date generated is empty', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent)
    ...
    it('return empty content when sbs content is no valid time generated is empty', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent)
    ...
    it('return empty content when sbs content is no valid date logged is empty', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent)
    ...
    it('return empty content when sbs content is no valid time logged is empty', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,2023/01/01,,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent)
    ...
    it('return empty content when sbs content is no valid icao is empty with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,,1,2023/01/01,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
    ...
    it('return empty content when sbs content is no valid date generated is empty with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
    ...
    it('return empty content when sbs content is no valid time generated is empty with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
    ...
    it('return empty content when sbs content is no valid date logged is empty with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
    ...
    it('return empty content when sbs content is no valid time logged is empty with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,2023/01/01,,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
  ...
  context('Data sbs valid', () => {
    it('return ndjson content when sbs content is valid', async () => {
      const sbsContent: string =
    ...
    it('return ndjson content when sbs content is valid with label', async () => {
      const sbsContent: string =
    ...
    it('return ndjson content when many attributes are empty', async () => {
      const sbsContent: string =
    ...
    it('return ndjson content when sbs content is valid with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
    ...
    it('return ndjson content when sbs content is valid with label with extraField', async () => {
      const sbsContent: string =
        'MSG,3,1,1,39c902,1,2023/01/01,13:21:11.000,2023/01/01,13:21:11.000,SAMU13,121.92,3.450995263850706,296.565051177078,43.289794921875,5.40233523346657,5.85216,,1,0,1,1,1,1024,{"altitude":"-45.72","last_position":"1672575670.76","lastcontact":"1672575670.797","hour":"1672574400"}'
      const ndjsonContent: string = convertSBStoNDJSON(sbsContent, true)
